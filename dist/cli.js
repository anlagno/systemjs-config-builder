...
(0, _index.traceModuleTree)(process.cwd()).then(_index.filterDevDependencies).then(_index.fromCache).then(_index.augmentModuleTree).then(_index.toCache).then(_index.pruneModuleTree).then(_index.generateConfig)
// .then(log)
