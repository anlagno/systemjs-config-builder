...
export const filterDevDependencies = ({tree, registry}) => {
    ...
    return Promise.resolve({tree, registry, filteredTree, filteredRegistry}).then(({tree, registry, filteredTree, filteredRegistry}) => {
